...
public class TestMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create a QuestionViewAdapter, whose data source is a list of Questions. The adapter knows
        // how to create list items for each item in the list.
        QuestionViewAdapter adapter = new QuestionViewAdapter(this, questions);
        ...
        // Make the ListView use the QuestionViewAdapter created above, so that the ListView will
